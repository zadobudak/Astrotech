...
class Detector(object):
    ...
    def detection(self, im: np.ndarray, frame_per_detection: int = 10,confThreshold: float = 0.7, nmsThreshold: float = .35):
        try:
            isLocked = False
            # Get frames
            ...
            isLocked_server, states = fsm(isLocked_server, self.states)
            print("states: ", states)
